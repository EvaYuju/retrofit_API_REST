package com.developez.retrofit_apirest.controller;

import com.developez.retrofit_apirest.dto.ProductDTO;
import com.developez.retrofit_apirest.model.Product;
...
public class ProductController {
    ...
    public ResponseEntity<Product> getOne(@PathVariable("id") int id) {
        Product product = findById(id); // No hay BDD no hay autoincrement, etc, lo tenemos que definir nosotros el id
